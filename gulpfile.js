...
// places data folder contents into dist
function copyData() {
	console.log('----COPYING DATA FOLDER INTO DIST FOLDER!----');
	return src([
			'src/assets/data/*',
		])
...
// TASK: $ gulp dev
exports.dev = series(cleanDist, copyData, copyFont, copyImages, compileHTML, compileJS, resetPages, compileSCSS, browserSyncInit, watchFiles);

// TASK: $ gulp build
exports.build = series(cleanDist, copyData, compileSCSS, copyFont, copyImages, compileHTML, concatScripts, minifyScripts, minifyCss, renameSources, browserSyncInit);